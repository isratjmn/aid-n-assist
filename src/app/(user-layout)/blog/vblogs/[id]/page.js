...
const SingleVolateersBlog = (props) => {
	const [svolBlog, setSvolBlog] = useState(null);
	...
	const getItemData = async () => {
		...
		let itemData = await fetch(`/api/vblogs/${item_Id}`);
