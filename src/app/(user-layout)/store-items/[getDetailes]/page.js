	...
	return (
		<div className="my-32">
			{isLoading ? (
				...
				<div>
					<h2 className="mt-32 mb-10 font-semibold text-center md:text-start md:ml-[420px] text-2xl md:text-5xl">
						{itemDetails.name}
					</h2>
					<div className="flex flex-col md:flex-row justify-evenly  mx-20">
						<div>
							...
							<Link href={"/store-items"}>
								<button className="mt-5 text-xl text-blue-400 bg-green-200 px-4 py-2 rounded-xl">
									<FaStore></FaStore>
								</button>
							</Link>
						</div>
						<div>
							...
							<p className="text-3xl max-w-sm md:mb-20 md:h-16">
							...
							<div>
								<button
									...
									className="rounded-xl bg-green-400  px-5 py-3 text-white my-5"
								>
									Add to Cart
								</button>
							</div>
							...
							<div className="max-w-md  mb-10">
								<h2 className="underline text-2xl mb-5">
									{" "}
									From Author:
								</h2>
								<p className="text-base">
									Your purchase not only benefits you 😊, but
									also makes a positive impact on a meaningful
									cause 🌍. Your money 💰 is well-spent by
									adding a donation 🙌 to your payment 💳.
								</p>
							</div>
					...
					<div>
						<div className="flex justify-start items-center gap-3 mx-20 md:ml-[370px] mt-10">
							<button
								className={`descriptionReview-button ${
									isDescriptionOpen ? "active" : ""
								}`}
								onClick={() => {
						...
						<div className="mx-20 md:ml-[370px] mt-5">
							...
							{isReviewsOpen && (
								<ul>
									<li className="mb-2">
										1. {itemDetails.reviews[0]}
									</li>
									<li className="mb-2">
										2. {itemDetails.reviews[1]}
									</li>
