...
export async function POST(request) {
    ...
    try {
        const data = {
            ...
            success_url: "https://aid-nassist-donation-website.vercel.app/api/storeSslPayments/payment-callback",
            fail_url: "https://aid-nassist-donation-website.vercel.app/api/storeSslPayments/payment-callback",
            cancel_url: "https://aid-nassist-donation-website.vercel.app/api/storeSslPayments/payment-callback",
            emi_option: 0,
            customer_name: "name",
            cus_email: email,
