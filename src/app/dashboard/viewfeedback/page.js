...
const ViewTheFeedBack = () => {
	...
	return (
		<div className="md:mx-auto">
			<h1 className="text-4xl font-extrabold text-center mt-0 pt-4 pb-12">
				Feedbacks
			</h1>
			<h1 className=" text-2xl font-bold ml-36 mb-8 mt-2 text-center md:ml-12 mx-auto">
				Total Feedbacks:
			...
			<div className="w-[80%] mx-auto">
				{loading ? (
					...
					<div className="md:grid md:grid-cols-1 lg:grid-cols-2 grid md:px-14 lg:px-14 md:ml-10 md:mr-14 gap-20">
...
export default ViewTheFeedBack;
