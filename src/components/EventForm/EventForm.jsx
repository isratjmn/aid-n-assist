...
const EventForm = () => {
	...
	return (
		<>
			<Toaster></Toaster>
			<div className="ml-0 lg:ml-[100px] mt-20 md:mt-32 md:ml-64">
				<form
					onSubmit={handleSubmit(onSubmit)}
					className="mx-2 md:mx-10 border-2 border-green-400 p-10 shadow-lg rounded my-10"
				>
					...
					<button
						type="submit"
						className="text-white bg-green-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-green-500 dark:focus:ring-blue-800"
					>
						Add Event
					</button>
				</form>
