...
const Navbar = () => {
		...
		if (user) {
			return (
				<div className="relative mt-2 md:mt-0">
					...
					<div
						className={`absolute right-0 mt-2 w-48 bg-white divide-y divide-gray-100 rounded-sm shadow dark:bg-black dark:divide-gray-600 ${
							isOpen
								? "opacity-100 visible"
								: "opacity-0 invisible"
	...
	return (
		<div className="bg-blue-900 dark:bg-black shadow-md text-white h-[80px] lg:h-[85px] flex fixed top-0 left-0 right-0 z-50">
