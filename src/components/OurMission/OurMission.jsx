	...
	return (
		<section className="py-12">
			<div className="mt-0 lg:mt-5">
				<h1 className="text-center max-w-3xl lg:max-w-4xl mx-auto text-4xl lg:text-4xl font-bold mb-8 pb-11">
					Welcome to AidNAssist, a nationwide charitable, non-profit
					organization
				</h1>
			</div>
			<div className="container mx-auto">
				<div className="grid gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-center items-center mt-10">
					{/* card 1 start */}
					<div className="relative w-full h-[300px] md:h-[500px] lg:h-[370px] mb-3 lg:mb-0 bg-green-400 rounded-lg">
